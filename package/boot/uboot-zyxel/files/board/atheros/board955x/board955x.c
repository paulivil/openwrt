...
{
#if defined(CONFIG_BOARD_NBG6716) || defined(CONFIG_BOARD_NBG6616) || defined(CONFIG_BOARD_EMG2926) || defined(CONFIG_BOARD_EMG2926OBM) || defined(CONFIG_BOARD_EMG2926AAVK) || defined(CONFIG_BOARD_EMG3425VT) || defined(CONFIG_BOARD_EMG3425AAYJ) || defined(CONFIG_BOARD_NBG6815)
