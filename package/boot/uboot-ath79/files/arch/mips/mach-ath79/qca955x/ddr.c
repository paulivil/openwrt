...
void ddr_init(void)
{
	...
	if (val & QCA955X_BOOTSTRAP_DDR1) {
		writel(DDR_CTL_CONFIG_VAL, regs + QCA955X_DDR_REG_CTL_CONF);
		udelay(10);
		...
		/* Burst size */
		writel(DDR_BURST_VAL, regs + QCA955X_DDR_REG_BURST);
		udelay(100);
		writel(DDR_BURST2_VAL, regs + QCA955X_DDR_REG_BURST2);
		udelay(100);

		/* AHB maximum timeout */
		writel(0xfffff, regs + QCA955X_DDR_REG_TIMEOUT_MAX);
		udelay(100);
		...
		udelay(100);
		writel(DDR1_CONF3_REG_VAL, regs + QCA955X_DDR_REG_CONFIG3);
		udelay(100);
		...
		udelay(100);
		writel(DDR2_CONF3_REG_VAL, regs + QCA955X_DDR_REG_CONFIG3);
		udelay(100);

		/* Enable DDR2 */
		writel(DDR2_CONF_VAL, regs + QCA955X_DDR_REG_DDR2_CONFIG);
		udelay(100);
