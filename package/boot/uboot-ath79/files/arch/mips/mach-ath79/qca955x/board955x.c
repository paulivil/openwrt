...
{
#if defined(CONFIG_BOARD_AP135) || defined(CONFIG_BOARD_NBG6716) || defined(CONFIG_BOARD_NBG6616) || defined(CONFIG_BOARD_EMG2926) || defined(CONFIG_BOARD_EMG2926OBM) || defined(CONFIG_BOARD_EMG2926AAVK) || defined(CONFIG_BOARD_EMG3425VT) || defined(CONFIG_BOARD_EMG3425AAYJ) || defined(CONFIG_BOARD_NBG6815)
  ...
  #if defined(CONFIG_BOARD_EMG3425AAYJ) || defined(CONFIG_BOARD_NBG6815)
	/* disable JTAG */
        ath_reg_rmw_set(GPIO_FUNCTION_ADDRESS, 2);
        /* Set GPIO 0 as output */
        ath_reg_rmw_clear(GPIO_OE_ADDRESS, 1);
	/* Pegatron suggest GPIO_11 should set Input */
        ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 11));
  #endif
  #if defined(CONFIG_BOARD_AP135) || defined(CONFIG_BOARD_NBG6616)
