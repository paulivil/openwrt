...
//#define CONFIG_MIPS32       1   /* MIPS32 CPU core  */ /* Moved to QCA956x board config */

//#define CONFIG_BOOTDELAY    2   /* autoboot after 4 seconds */ /* Moved to QCA956x board config */

//#define CONFIG_BAUDRATE     115200 /* Moved to QCA956x board config */
//#define CFG_BAUDRATE_TABLE  {115200}	/* Moved to QCA956x board config */

//#define CONFIG_TIMESTAMP        /* Print image info with timestamp */ /* Moved to QCA956x board config */
 ...
 * Cache Configuration
 */
//#define CFG_DCACHE_SIZE     32768	/* Moved to QCA956x board config */
//#define CFG_ICACHE_SIZE     65536	/* Moved to QCA956x board config */
//#define CFG_CACHELINE_SIZE  32	/* Moved to QCA956x board config */
